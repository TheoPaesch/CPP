...
/*   Updated: 2025/01/04 00:00:22 by tpaesch          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	try
	{
		...
		AForm form1("Existential Crisis Evaluation", 1, 1);
	...
	{
		Bureaucrat bob("Bob", 1);
		AForm form1("Mood Swing Documentation Sheet", 2, 2);
	...
	try
	{
		...
		AForm form1("Sarcastic Satisfaction Survey", 150, 150);
